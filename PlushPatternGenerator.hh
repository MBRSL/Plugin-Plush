...
public:
    ...
    ///@{
    /// The seams generated by connecting non-developable points
    static OpenMesh::MPropHandleT< std::vector<EdgeHandle> > seamsHandle;
    /// The boundary used for flattening. It's generated by seams.
